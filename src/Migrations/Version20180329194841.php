 ...
 */
class Version20180329194841 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(500) NOT NULL, permalink VARCHAR(500) NOT NULL, image VARCHAR(16) DEFAULT NULL, image_orientation VARCHAR(10) DEFAULT NULL, enabled TINYINT(1) NOT NULL, released DATETIME NOT NULL, crawled DATETIME NOT NULL, UNIQUE INDEX UNIQ_DA88B137C53D045F (image), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recipe_category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, slug VARCHAR(50) NOT NULL, enabled TINYINT(1) NOT NULL, alternative VARCHAR(500) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
