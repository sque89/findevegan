 ...
 */
class Version20180517173309 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE recipe_category (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(50) NOT NULL, slug VARCHAR(50) NOT NULL, enabled TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_70DCBC5F989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE searchterm (id INT AUTO_INCREMENT NOT NULL, term VARCHAR(100) NOT NULL, first_search DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', latest_search DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', latest_result_count INT NOT NULL, count INT NOT NULL, UNIQUE INDEX UNIQ_2CDF8AC8A50FE78D (term), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
